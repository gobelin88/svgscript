...
private:
    ...
    void draw_gear_r(QPainterPath & path, double x, double y, double m, int n, double alpha, double daxe, int nb_spokes=-1);
    void draw_gear(QPainterPath & path, double x, double y, double m, int n, double alpha, double daxe, int nb_spokes=-1);
