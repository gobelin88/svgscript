...
static const Command CommandsList[NB_CMD]={
    ...
    Command("DRAW_ELLIPSE_CRENEAUX",QObject::tr("x y r1 r2 w dL n m t:\n\nDessine une ellipse de rayons (r1) et (r2) en (x,y). Créneaux de longueur (dL) et d'epaisseur (w)\nLe parametre (n,m) nombres de creneaux -1 pour le calcul automatique et (t) le type de creneau")),
    ...
    Command("DRAW_GEAR_R",          QObject::tr("x y m n alpha e :\n\n Dessine un pignon type reverse (e) epaisseur")),
